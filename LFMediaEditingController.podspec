...
ss.source_files = 'LFMediaEditingController/class/LFPhotoEditingController/**/*.{h,m}'
ss.public_header_files = 'LFMediaEditingController/class/LFPhotoEditingController/controller/*.h','LFMediaEditingController/class/LFPhotoEditingController/model/*.h'
